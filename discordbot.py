...
async def button_a(ctx, *, nom_de_salon):
  ...
  guild.me: discord.PermissionOverwrite(read_messages=True),autorize_role: discord.PermissionOverwrite(read_messages=True)
  }
  await guild.create_text_channe(nom_de_salon,overwrites=overwrites)
